...
void GeneralTwo();//일반용 연산 계산기 
void Per(double x, double y);//백분율

void GeneralOne();//일반용 루트 계산기 
...
void GeneralTwo()// 일반용 계산기
{
	double a, c;
	int b;
	clrscr();
	printf("[일반용] 일반연산 계산기 입니다\n\n");
	printf("[1] - [2] + [3] / [4] * [5] %% \n\n");
	printf("첫번째 숫자 입력하세요\n");
	scanf("%lf", &a);
	printf("연산을 입력하세요\n");
...
void GeneralOne()// 루트  계산기
{
	double a;
	int b;
	clrscr();
	printf("[일반용] 루트  계산기 입니다\n\n");
	printf("[1] Sprt [2] 1/x  \n\n");
	printf("숫자를 입력하세요\n");
	scanf("%lf", &a);
	printf("연산을 입력하세요\n");
...
void EngineeringOwn()//공학계산기 -1 
{
	double a;
	int b;
	clrscr();
	printf("[공학용] 공학  계산기-1 입니다\n\n");
...
void EngineeringTwo()//공학계산기 -2
{
	double a, c;
	int b;
	clrscr();
	printf("[공학용] 공학 계산기-2 입니다\n\n");
...
void Binary(double x) //정수입력 -> 2진수 출력
{
	int binary = 0;
	int i = 1;
	int j;
...
void Cul8()
{
	...
	printf("첫번째 숫자 입력하세요(8진수)\n");
	scanf("%o", &a);
	printf("연산을 입력하세요\n");
	scanf("%d", &b);
	printf("두번째째 숫자 입력하세요(8진수)\n");
	scanf("%o", &c);
...
void Cul16()
{
	...
	printf("첫번째 숫자 입력하세요(16진수)\n");
	scanf("%X", &a);
	printf("연산을 입력하세요\n");
	scanf("%d", &b);
	printf("두번째째 숫자 입력하세요(16진수)\n");
	scanf("%X", &c);
...
void HexMinus(int x, int y)// 16진수 -
{
	printf("=\n");
	printf("%X\n", x - y);
}
